              ...
              >
                {msg.role === 'user' ? (
                  ...
                  <div className="response-card">
                    ...
                    {msg.warning && (
                      <div className="warning-banner" style={{ background: '#fff3cd', color: '#856404', padding: '0.8rem', borderRadius: 'var(--radius-sm)', marginBottom: '1rem', fontSize: '0.9rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
