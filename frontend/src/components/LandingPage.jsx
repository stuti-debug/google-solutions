...
const LandingPage = () => {
  ...
  return (
    <main id="screen-login" className="screen active fade-in flex-center" aria-label="Login">
      <div className="landing-container">
        <section className="landing-content" aria-labelledby="hero-headline">
          <div className="brand-badge">
            <i className="ph-fill ph-grid-four" aria-hidden="true"></i> CrisisGrid
          </div>

          <h1 id="hero-headline" className="hero-headline">Turn your messy NGO data into actionable insights in seconds.</h1>
          ...
          <div className="sdg-section">
            ...
            <div className="sdg-badges-row">
              <div className="sdg-badge-custom sdg-11">
                <span className="sdg-dot" aria-hidden="true"></span>
          ...
          <div className="auth-actions">
            <button className="btn btn-google full-width" onClick={signInWithGoogle} disabled={loading} aria-live="polite">
              <svg className="google-icon" viewBox="0 0 24 24" width="20" height="20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <footer className="landing-footer">
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', gap: '0.8rem', alignItems: 'center', opacity: 0.8 }}>
            <span role="img" style={{ fontSize: '1.3rem', display: 'flex', alignItems: 'center', color: 'var(--clr-text)' }} title="Gemini API" aria-label="Gemini API"><i className="ph-fill ph-sparkle" style={{ color: '#4285F4' }} aria-hidden="true"></i></span>
            <span role="img" style={{ fontSize: '1.3rem', display: 'flex', alignItems: 'center', color: 'var(--clr-text)' }} title="Firebase" aria-label="Firebase"><i className="ph-fill ph-database" style={{ color: '#FFCA28' }} aria-hidden="true"></i></span>
            <span role="img" style={{ fontSize: '1.3rem', display: 'flex', alignItems: 'center', color: 'var(--clr-text)' }} title="React" aria-label="React"><i className="ph-fill ph-atom" style={{ color: '#61DAFB' }} aria-hidden="true"></i></span>
          </div>
        </div>
      </footer>
    </main>
